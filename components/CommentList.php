...
class CommentList extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'spanjaan.bloghub::lang.components.comments_list.label',
            'description' => 'spanjaan.bloghub::lang.components.comments_list.comment'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            ...
            'excludePosts' => [
                'title'             => 'spanjaan.bloghub::lang.components.comments_list.exclude_posts',
                'description'       => 'spanjaan.bloghub::lang.components.comments_list.exclude_posts_description',
                'type'              => 'string',
                'default'           => '',
            ],
            'amount' => [
                'title'             => 'spanjaan.bloghub::lang.components.comments_list.amount',
                'description'       => 'spanjaan.bloghub::lang.components.comments_list.amount_description',
                'type'              => 'string',
                'validationPattern' => '^[0-9]+$',
                'validationMessage' => 'spanjaan.bloghub::lang.components.comments_list.amount_validation',
                'default'           => '5',
            ],
            'sortOrder' => [
            ...
            'onlyFavorites' => [
                'title'             => 'spanjaan.bloghub::lang.components.comments_list.only_favorites',
                'description'       => 'spanjaan.bloghub::lang.components.comments_list.only_favorites_description',
                'type'              => 'checkbox',
                'default'           => '0'
            ],
            'hideOnDislikes' => [
                'title'             => 'spanjaan.bloghub::lang.components.comments_section.hide_on_dislike',
                'description'       => 'spanjaan.bloghub::lang.components.comments_section.hide_on_dislike_description',
                'type'              => 'string',
                'default'           => '0'
            ]
        ];
