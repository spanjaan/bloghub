...
use Spanjaan\BlogHub\Models\BlogHubSettings;
...
class CommentSection extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'spanjaan.bloghub::lang.components.comments_section.label',
            'description' => 'spanjaan.bloghub::lang.components.comments_section.comment'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'postSlug' => [
                'title'             => 'spanjaan.bloghub::lang.components.comments_section.post_slug',
                'description'       => 'spanjaan.bloghub::lang.components.comments_section.post_slug_comment',
                'type'              => 'dropdown',
                'default'           => '',
            ],
            'commentsPerPage' => [
                'title'             => 'spanjaan.bloghub::lang.components.comments_section.comments_per_page',
                'type'              => 'string',
            ...
            'sortOrder' => [
                'title'             => 'spanjaan.bloghub::lang.components.comments_section.comments_order',
                'description'       => 'spanjaan.bloghub::lang.components.comments_section.comments_order_comment',
                'type'              => 'dropdown',
                'default'           => 'created_at desc',
            ],
            'commentHierarchy' => [
                'title'             => 'spanjaan.bloghub::lang.components.comments_section.comments_hierarchy',
                'description'       => 'spanjaan.bloghub::lang.components.comments_section.comments_hierarchy_comment',
                'type'              => 'checkbox',
                'default'           => '1'
            ],
            'commentsAnchor' => [
                'title'             => 'spanjaan.bloghub::lang.components.comments_section.comments_anchor',
                'description'       => 'spanjaan.bloghub::lang.components.comments_section.comments_anchor_comment',
                'type'              => 'string',
                'default'           => 'comments'
            ],
            'pinFavorites' => [
                'title'             => 'spanjaan.bloghub::lang.components.comments_section.pin_favorites',
                'description'       => 'spanjaan.bloghub::lang.components.comments_section.pin_favorites_comment',
                'type'              => 'checkbox',
                'default'           => '0'
            ],
            'hideOnDislikes' => [
                'title'             => 'spanjaan.bloghub::lang.components.comments_section.hide_on_dislike',
                'description'       => 'spanjaan.bloghub::lang.components.comments_section.hide_on_dislike_comment',
                'type'              => 'string',
                'default'           => '0'
            ],
            'formPosition' => [
                'group'             => 'spanjaan.bloghub::lang.components.comments_section.group_form',
                'title'             => 'spanjaan.bloghub::lang.components.comments_section.form_position',
                'description'       => 'spanjaan.bloghub::lang.components.comments_section.form_position_comment',
                'type'              => 'dropdown',
                'default'           => 'above',
                'useSearch'         => false,
                'options'           => [
                    'above'             => 'spanjaan.bloghub::lang.components.comments_section.form_position_above',
                    'below'             => 'spanjaan.bloghub::lang.components.comments_section.form_position_below',
                ]
            ],
            'disableForm' => [
                'group'             => 'spanjaan.bloghub::lang.components.comments_section.group_form',
                'title'             => 'spanjaan.bloghub::lang.components.comments_section.disable_form',
                'description'       => 'spanjaan.bloghub::lang.components.comments_section.disable_form_comment',
                'type'              => 'checkbox',
                'default'           => '0'
            ],
        ];
    ...
    {
        return [
            'created_at DESC'   => Lang::get('spanjaan.bloghub::lang.sorting.created_at_desc'),
            'created_at ASC'    => Lang::get('spanjaan.bloghub::lang.sorting.created_at_asc'),
            'likes DESC'        => Lang::get('spanjaan.bloghub::lang.sorting.likes_desc'),
            'likes ASC'         => Lang::get('spanjaan.bloghub::lang.sorting.likes_asc'),
            'dislikes DESC'     => Lang::get('spanjaan.bloghub::lang.sorting.dislikes_desc'),
            'dislikes ASC'      => Lang::get('spanjaan.bloghub::lang.sorting.dislikes_asc'),
        ];
    }
            ...
            $query->where(function ($builder) {
                $builder->where('status', 'approved')->orWhere(function ($builder) {
                    $builder->where('status', 'pending')
                        ...
                        ->where('author_table', 'Spanjaan\\BlogHub\\Models\\Visitor');
                });
            });
        }
    ...
    public function onRun()
    {
        ...
        if (empty($post) || (!empty($post) && $post->spanjaan_bloghub_comment_visible === '0')) {
            ...
            //$this->addJs('/plugins/spanjaan/bloghub/assets/js/comments-legacy.js');

            $this->addJs('/plugins/spanjaan/bloghub/assets/js/comments.js');

            $this->addCss('/plugins/spanjaan/bloghub/assets/css/comments.css');
        }
    }
    ...
    protected function prepareVars(Post $post)
    {
        ...
        // Set Comments Mode
        $this->page['commentsMode'] = $post->spanjaan_bloghub_comment_mode;
        ...
        $this->page['currentUserCanModerate'] = $this->page['currentUserIsBackend'] && $user && $user->hasPermission('spanjaan.bloghub.comments.moderate_comments');
    ...
    protected function validateAjaxMethod()
    {
        if (empty($post = $this->getPost())) {
            throw new AjaxException(Lang::get('spanjaan.bloghub::lang.frontend.errors.unknown_post'));
        }
        $this->prepareVars($post);

        // Check if Comment exists
        if (empty($comment_id = input('comment_id'))) {
            throw new AjaxException(Lang::get('spanjaan.bloghub::lang.frontend.errors.missing_comment_id'));
        }
        if (empty($comment = Comment::where('id', $comment_id)->first())) {
            throw new AjaxException(Lang::get('spanjaan.bloghub::lang.frontend.errors.invalid_comment_id'));
        }
    ...
    public function onChangeStatus()
    {
        ...
        if (empty($status = input('status')) || !in_array($status, ['favorite', 'approve', 'reject', 'spam'])) {
            throw new AjaxException(Lang::get('spanjaan.bloghub::lang.frontend.errors.unknown_error'));
        }
        ...
        if ($status === 'favorite') {
            ...
            if ($this->config('author_favorites') !== '1') {
                throw new AjaxException(Lang::get('spanjaan.bloghub::lang.frontend.errors.disabled_method'));
            }

            // Check if current user can favorite
            if (!$this->page['currentUserCanFavorite']) {
                throw new AjaxException(Lang::get('spanjaan.bloghub::lang.frontend.errors.not_allowed_to'));
            }
        ...
        elseif ($status === 'approve' || $status === 'reject' || $status === 'spam') {
            ...
            if (!$this->page['currentUserCanModerate']) {
                throw new AjaxException(Lang::get('spanjaan.bloghub::lang.frontend.errors.no_permissions_for'));
            }
    ...
    public function onCreateReply()
    {
        ...
        if (!$this->page['showCommentsForm']) {
            throw new AjaxException(Lang::get('spanjaan.bloghub::lang.frontend.errors.form_disabled'));
        }

        // Check if current user can comment
        if (!$this->page['currentUserCanComment']) {
            throw new AjaxException(Lang::get('spanjaan.bloghub::lang.frontend.errors.not_allowed_to_comment'));
        }
        ...
        return [
            ...
            'comment' => $comment,
            'submitText' => Lang::get('spanjaan.bloghub::lang.frontend.comments.submit_reply')
        ];
    }
    ...
    {
        return [
            'submitText' => Lang::get('spanjaan.bloghub::lang.frontend.comments.submit_comment')
        ];
    }
    ...
    public function onComment()
    {
        ...
        if (!$this->verifyCsrfToken()) {
            throw new AjaxException([
                'message' => Lang::get('spanjaan.bloghub::lang.frontend.errors.invalid_csrf_token')
            ]);
        }
        ...
        if (!$this->verifyValidationCode(input('comment_validation'), input('comment_time'), $hasCaptcha, $hasHoneypot)) {
            throw new AjaxException([
                'message' => Lang::get('spanjaan.bloghub::lang.frontend.errors.invalid_validation_code')
            ]);
        }
        ...
        if ($hasCaptcha) {
            if (strtoupper(Session::get('bloghubCaptchaPhrase')) !== strtoupper(input('comment_captcha'))) {
                ...
                throw new AjaxException([
                    'message' => Lang::get('spanjaan.bloghub::lang.frontend.errors.invalid_captcha') . Session::get('bloghubCaptchaPhrase'),
                    'captchaImage' => $builder->inline()
                ]);
            }
        }
        ...
        if ($hasHoneypot) {
            ...
            if (empty($honey) || !empty(input('comment_user')) || !empty(input('comment_email'))) {
                throw new AjaxException([
                    'message' => Lang::get('spanjaan.bloghub::lang.frontend.errors.honeypot_filled')
                ]);
            }
        ...
        if (!$this->page['currentUserCanComment']) {
            throw new AjaxException([
                'message' => Lang::get('spanjaan.bloghub::lang.frontend.errors.not_allowed_to_commentd')
            ]);
        }
        ...
        if ($this->page['showCommentFormTos'] && input('comment_tos') !== '1') {
            throw new AjaxException([
                'message' => Lang::get('spanjaan.bloghub::lang.frontend.errors.tos_not_accepted')
            ]);
        }
        ...
        if (!empty($parentId)) {
            ...
            if (empty($parent = Comment::where('id', $parentId)->first())) {
                throw new AjaxException([
                    'message' => Lang::get('spanjaan.bloghub::lang.frontend.errors.parent_not_found')
                ]);
            }
            ...
            if (intval($parent->post_id) !== intval($post->id)) {
                throw new AjaxException([
                    'message' => Lang::get('spanjaan.bloghub::lang.frontend.errors.parent_invalid')
                ]);
            }
