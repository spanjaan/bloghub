...
class PostsByCommentCount extends Posts
{
    ...
    {
        return [
            'name'          => 'spanjaan.bloghub::lang.components.comment_count.label',
            'description'   => 'spanjaan.bloghub::lang.components.comment_count.comment'
        ];
    }
    ...
    protected function listPosts()
    {
        ...
        $posts = Post::with(['categories', 'featured_images', 'spanjaan_bloghub_tags'])
            ->withCount('spanjaan_bloghub_comments')
            ->listFrontEnd([
                'page'             => $this->property('pageNumber'),
                'sort'             => 'spanjaan_bloghub_comments_count desc',
