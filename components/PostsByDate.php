...
class PostsByDate extends Posts
{
    ...
    {
        return [
            'name'          => 'spanjaan.bloghub::lang.components.date.label',
            'description'   => 'spanjaan.bloghub::lang.components.date.comment'
        ];
    }
    ...
    */
    public function defineProperties()
    {
        $properties['dateFilter'] = [
            'title'         => 'spanjaan.bloghub::lang.components.date.filter',
            'description'   => 'spanjaan.bloghub::lang.components.date.filter_comment',
            'type'          => 'string',
            'default'       => '{{ :date }}',
        ];
        $properties['archiveDate'] = [
            'title'         => 'spanjaan.bloghub::lang.components.archive_date.title',
            'description'   => 'spanjaan.bloghub::lang.components.archive_date.description',
            'type'          => 'string',
            'default'       => 'blog/date',
        ];
        $properties['date404OnInvalid'] = [
            'title'         => 'spanjaan.bloghub::lang.components.date_404_on_invalid.title',
            'description'   => 'spanjaan.bloghub::lang.components.date_404_on_invalid.description',
            'type'          => 'checkbox',
            'default'       => 1,
        ];
        $properties['date404OnEmpty'] = [
            'title'         => 'spanjaan.bloghub::lang.components.date_404_on_empty.title',
            'description'   => 'spanjaan.bloghub::lang.components.date_404_on_empty.description',
            'type'          => 'checkbox',
            'default'       => 1,
        ];
    ...
    */
    ...
    protected function listPosts()
    {
        ...
        $posts = Post::with(['categories', 'featured_images', 'spanjaan_bloghub_tags'])
