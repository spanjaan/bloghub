...
namespace Spanjaan\BlogHub\Models;
...
class Comment extends Model
{
     ...
     * @var string
     */
    public $table = 'spanjaan_bloghub_comments';
    ...
    public function getStatusOptions()
    {
        return [
            ...
            'approved'  => Lang::get('spanjaan.bloghub::lang.model.comments.statusApproved'),
    ...
    public function getDisplayNameAttribute(): string
    {
        if (!empty($this->author)) {
            ...
            return trans('spanjaan.bloghub::lang.model.comments.guest');
        }
    }
    ...
    public function getPublishedAgoAttribute(): string
    {
        ...
        if ($seconds >= 2419200) {
            ...
            return trans('spanjaan.bloghub::lang.model.comments.seconds_ago');
        }

        return trans('spanjaan.bloghub::lang.model.comments.x_ago', [
            'amount' => $amount,
            'format' => trans('spanjaan.bloghub::lang.model.post.published_format_' . $format)
        ]);
    }
