...
class BlogHubSettings extends Model
{
    ...
    public static function defaultValue($key)
    {
        return [
            ...
            "form_tos_label" => Lang::get('spanjaan.bloghub::lang.settings.comments.form_tos_label.default'),
     ...
     * @var string
     */
    public $settingsCode = 'spanjaan_bloghub_core_settings';
    ...
    {
        $options = [
            'cms_page' => Lang::get('spanjaan.bloghub::lang.settings.comments.form_tos_type.cms_page')
        ];

        if (PluginManager::instance()->hasPlugin('Winter.Pages')) {
            $options['static_page'] = Lang::get('spanjaan.bloghub::lang.settings.comments.form_tos_type.static_page');
        }
