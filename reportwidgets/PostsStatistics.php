...
class PostsStatistics extends ReportWidgetBase
{
    ...
    public function defineProperties()
    {
        return [
            'defaultDateRange' => [
                'title'         => 'spanjaan.bloghub::lang.components.post.date_range',
                'description'   => 'spanjaan.bloghub::lang.components.post.date_range_comment',
                'type'          => 'dropdown',
                'default'       => '14 days',
            ],
        ];
    ...
    {
        return [
            '7 days'        => Lang::get('spanjaan.bloghub::lang.components.post.7days'),
            '14 days'       => Lang::get('spanjaan.bloghub::lang.components.post.14days'),
            '31 days'       => Lang::get('spanjaan.bloghub::lang.components.post.31days'),
            '3 months'      => Lang::get('spanjaan.bloghub::lang.components.post.3months'),
            '6 months'      => Lang::get('spanjaan.bloghub::lang.components.post.6months'),
            '12 months'     => Lang::get('spanjaan.bloghub::lang.components.post.12months')
        ];
    }
    ...
    protected function getGeneralStatistics($range)
    {
        ...
        for ($i = 0; $i < 7; $i++) {
            ...
            $result['views'][] = '[' . $timestamp*1000 . ', ' . $count->sum('spanjaan_bloghub_views') . ']';
            $result['visitors'][] = '[' . $timestamp*1000 . ', ' . $count->sum('spanjaan_bloghub_unique_views') . ']';
        }
